  ...
  <tbody>
            <?php
                   ...
                   //$row = mysqli_fetch_array($result);
                    $result = mysqli_query($conn,"SELECT * FROM medicine where diseaseCategory='".$str1."';") or die("Failed to fetch".mysql_error());
                    if( mysqli_num_rows( $result)==0 ){
                        $result1 = mysqli_query($conn,"SELECT * FROM medicine where Medid='".$str1."';") or die("Failed to fetch".mysql_error()); 
